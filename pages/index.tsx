      ...
      <section id="how-it-works" className="max-w-6xl mx-auto py-12 sm:py-16 lg:py-24 px-4 sm:px-6">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
          {[
            ...
            { icon: "🧠", num: "02", title: "시놉시스를 분석합니다", desc: "TF-IDF가 줄거리 내용을 분석해서 비슷한 테마의 애니메이션을 찾아냅니다. 학교물+마법+우정 같은 키워드로요." },
            { icon: "✨", num: "03", title: "인생작 발굴", desc: "비슷한 스토리의 애니메이션을 추천해드립니다. 내용이 진짜 비슷해서 정주행 각입니다." },
          ].map((step, i) => (
            <div
              key={i}
